--[[
    Template PvP Mission Script - Version: 1.01 - 12/11/2019 by Theodossis Papadopoulos 
       ]]
...
function GROUP_DEAD:onEvent(event)
  ...
  if(event.id == world.event.S_EVENT_DEAD) then
    ...
    elseif isCurrentOperationMapObjBlue() == true and isDone == false and tonumber(event.initiator:getName()) ~= nil then
      local totalNames = tablelength(getCurrentOperationGroupNameBlue())
      local deathCounter = 0
      for i=1, totalNames do
    ...
    if isCurrentOperationMapObjRed() == false and isDone == false and tonumber(event.initiator:getName()) == nil then
      local _grp = Unit.getGroup(event.initiator)
    ...
    elseif isCurrentOperationMapObjRed() == true and isDone == false and tonumber(event.initiator:getName()) ~= nil then
      local totalNames = tablelength(getCurrentOperationGroupNameRed())
      local deathCounter = 0
      for i=1, totalNames do
